...
public class ShowExpendByMonthTest {
    ...
    @Test
    public void showExpendByMonthTest() {
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView_details_expend), withText("-5000.0"),
                        withParent(allOf(withId(R.id.constraintLayout1),
                                withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
        textView.check(matches(withText("-5000.0")));
    }
}
